  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        ...
        />
        <Text style={styles.companyName}>HARESH AGRO INDUSTRIES</Text>
        <Text style={styles.companyAddress}>
          Shivaji Nagar, Street no.3, Savarkundla, Gujarat, 364514, India
        </Text>
      </View>
      ...
      <View style={styles.footer}>
        <Text>
          Invoice generated by Haresh Agro Industries | www.hareshagro.com | +91
          1234567890
        </Text>
      </View>
    </Page>
